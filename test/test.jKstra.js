...
describe('Graph', function() {
  ...
  describe('addEdge()', function() {
    ...
    it('returns an edge object with from/to vertices and a properly set data field', function() {
      var u = G.addVertex('from');
      var v = G.addVertex('to');
      var e = G.addEdge(u, v, 'bar');
  ...
  describe('addEdgePair()', function() {
    ...
    it('returns an array of two edges with opposite from/to and the same data', function() {
      var u = G.addVertex('from');
      var v = G.addVertex('to');
      var pair = G.addEdgePair(u, v, 'bar');
      assert.isArray(pair);
  ...
  describe('incidentEdges()', function() {
    ...
    it('returns incident edges of the vertex in the given direction and verifying the filter function', function() {
      var outA = G.incidentEdges(vA, jKstra.OUT, function(e) { return e.data > 20; });
  ...
  describe('vertex', function(){
    ...
    it('returns a vertex matching all or part of the properties', function(){
      var a = G.addVertex('a');
      var b = G.addVertex(1);
      var c = G.addVertex({foo: 'a', bar: 1});
      var n = G.addVertex(null);
  ...
  describe('edge', function(){
    ...
    it('returns null if no edge matches the properties', function(){
      var vA = G.addVertex('A');
      var vB = G.addVertex('B');
      var vC = G.addVertex('C');
    ...
    it('returns an edge matching all or parf of the properties', function(){
      ...
      var vB = G.addVertex('B');
      var vC = G.addVertex('C');
      var eAB = G.addEdge(vA, vB, 'a');
      var eCA = G.addEdge(vC, vA, 1);
      var eBC = G.addEdge(vB, vC, {foo: 'a', bar: 1});
  ...
  describe('removeVertex()', function() {
    it('removes the vertex and all incident edges', function() {
      var vA = G.addVertex('A');
      var vB = G.addVertex('B');
      var vC = G.addVertex('C');
      G.addEdgePair(vA, vB, 'AB');
      G.addEdge(vC, vA, 'CA');
      var eBC = G.addEdge(vB, vC, 'BC');
      G.removeVertex(vA);
...
describe('Dijkstra', function(){
  ...
  var dijkstra = new jk.Dijkstra(G);
  ...
  describe('shortestPath()', function(){
    ...
    it('returns an empty path between a node and itself', function(){
      var path = dijkstra.shortestPath(n[0], n[0]);
      assert.isArray(path);
      assert.equal(path.length, 0);
    });
    
    it('returns the shortest path as an edge array', function(){
      var path = dijkstra.shortestPath(n[0], n[4], { edgeCost: function(e){ return(e.data); } });
      assert.isArray(path);
