  ...
  })(
    {
            ...
            _createClass(BidirectionalDijkstra, [
              {
                ...
                value: function rebuildPath(meetingNode) {
                  ...
                  while (
                    (edge = this.outFlagger.getFlags(currentNode).inc) !== null
                  ) {
                    edges.push(edge);
                  ...
                  // going upward in the tree until the first vertex (with no incoming edge)
                  while (
                    (edge = this.inFlagger.getFlags(currentNode).inc) !== null
                  ) {
                    edges.push(edge);
                    currentNode = edge.to;
                  }
              ...
              },
              {
                ...
                value: function _hasBeenReachBothWays(node) {
                  ...
                  return (
                    (outState.state === _constants.REACHED ||
                      outState.state === _constants.SETTLED) &&
                    (inState.state === _constants.REACHED ||
                      inState.state === _constants.SETTLED)
                  );
                },
              },
              {
                ...
                value: function shortestPath(source, target, options) {
                  var outIteraror = new _DijkstraIterator2.default(
                    this.graph,
                    source,
                    _extends({}, options, options.OUT, {
                      direction: _constants.OUT,
                      flagKey: this.outKey,
                    })
                  );
                  var inIterator = new _DijkstraIterator2.default(
                    this.graph,
                    target,
                    _extends({}, options, options.IN, {
                      direction: _constants.IN,
                      flagKey: this.inKey,
                    })
                  );
                  this.outFlagger = new _nodeFlagger2.default(
                    this.graph,
                    this.outKey
                  );
                  this.inFlagger = new _nodeFlagger2.default(
                    this.graph,
                    this.inKey
                  );
                  ...
                  while (!(next = iterator.next()).done) {
                    ...
                    iterator =
                      iterator === outIteraror ? inIterator : outIteraror;
                  }
        ...
        function (require, module, exports) {
          ...
          var Dijkstra = (function () {
            function Dijkstra(graph, opts) {
              ...
              this.nodeFlagger = new _nodeFlagger2.default(
                this.graph,
                this.options.flagKey
              );
            }
        ...
        */
                value: function shortestPath(source, target, opts) {
                  ...
                  options.isFinished = function () {
                    return (
                      _this.nodeFlagger.getFlags(target).state ===
                      _constants.SETTLED
                    );
                  };
        ...
        */
              },
              {
                ...
                value: function traverse(source, opts) {
                  ...
                  var dijkstraIterator = new _DijkstraIterator2.default(
                    this.graph,
                    source,
                    opts
                  );
      ...
      4: [
        function (require, module, exports) {
          ...
          var _updatablePriorityQueue2 = _interopRequireDefault(
            _updatablePriorityQueue
          );
          ...
          var DijkstraIterator = (function () {
            ...
            function DijkstraIterator(graph, source, opts) {
              ...
              this.flags = new _nodeFlagger2.default(
                this.graph,
                this.options.flagKey
              );
            ...
            _createClass(DijkstraIterator, [
              ...
              },
              {
                ...
                value: function _initTraversal() {
                  ...
                  this.pQ.insert(
                    this.source,
                    this.options.heuristic(this.source)
                  );
                  this._reach(
                    this.source,
                    null,
              ...
              },
              {
                ...
                value: function next() {
                  ...
                  var edges = this.graph.incidentEdges(
                    u,
                    direction,
                    edgeFilter
                  );
                  ...
                  try {
                    for (
                      var _iterator = edges[Symbol.iterator](), _step;
                      ...
                      if (vFlags.state !== _constants.SETTLED) {
                        ...
                        if (vFlags.state !== _constants.REACHED) {
                          ...
                          if (
                            shouldUpdateKey(vFlags.fCost, vFCost, vFlags.inc, e)
                          ) {
      ...
      8: [
        function (require, module, exports) {
          ...
          function isScalar(o) {
            return /boolean|number|string/.test(
      ...
      9: [
        function (require, module, exports) {
          ...
          var _BidirectionalDijkstra2 = _interopRequireDefault(
            _BidirectionalDijkstra
          );
        ...
        {
          "./algos/BFS.js": 1,
          "./algos/BidirectionalDijkstra.js": 2,
          "./algos/Dijkstra.js": 3,
          "./algos/DijkstraIterator.js": 4,
          "./core/Graph.js": 6,
          "./core/constants.js": 7,
                  ...
                  while (true) {
                    ...
                    if (lChildIdx < length) {
                      ...
                      if (rChildIdx < length) {
                        ...
                        if (
                          (swapIdx === -1 ||
                            this._compare(rChild, lChild) < 0) &&
                          this._compare(rChild, element) < 0
                        ) {
                          swapIdx = rChildIdx;
                        }
                      }
